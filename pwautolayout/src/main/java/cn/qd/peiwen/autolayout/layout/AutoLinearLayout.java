...
public class AutoLinearLayout extends LinearLayout {
    ...
    private AutoLayoutHelper autoLayoutHelper = new AutoLayoutHelper(this);
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams implements AutoLayoutParams {
